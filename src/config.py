...
# OAuth 2.0 Client Settings
AUTH_CONFIG = {
    'OAUTH_CLIENT_ID': '33578192036-23r0sqq67a9kf6an0vpgcqsbbrkovsud.apps.googleusercontent.com',
    'OAUTH_CLIENT_SECRET': 'YNGardeiofxrvbGBQAH4Kh_8',

    # E.g. Local Dev Env on port 8080: http://localhost:8080
    # E.g. Hosted on App Engine: https://your-application-id.appspot.com
    'OAUTH_REDIRECT_URI': '%s%s' % (
        'https://gellos-games-webpage.europe-west6.r.appspot.com',
        '/admin/auth')
}

# XSRF Settings
XSRF_KEY = 'OneAShipThatDoNotSpeekWithTreesDaly'

#gellos-games-webpage.de.r.appspot.com
#'https://gellos-games-webpage.europe-west6.r.appspot.com'